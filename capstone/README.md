...
Please read the **deliverables** folder carefully as it contains individual projects. Each project is sufficient to be added onto your resume as a standalone project.

## Project 3: Capstone Project (Optional)
